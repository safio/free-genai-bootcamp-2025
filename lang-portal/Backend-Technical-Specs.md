...
- The backend will be built using Rust
- The database will be SQLite3
- The API will be built using Actix-web
- Cargo Make will be used as the task runner
...
Our database will be a single sqlite database called `words.db` that will be in the root of the project folder of `lang-portal-backend`
